    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="gateway" class="form-control @error('gateway') is-invalid @enderror" value="{{old('gateway')}}" placeholder="0.0.0.0">
                    @error('gateway')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group">
                ...
                <br>
                <div class="col-sm-3">
                    <input class="form-check-input" type="checkbox" name="suppress-hw-offload" value="1">
            ...
            <div class="form-group">
                <div class="col-sm-3">
                    <input class="form-check-input" type="checkbox" name="blackhole" value="1">
